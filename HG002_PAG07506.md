...
- [HG002 sample ran on PAG07506 flowcell](#hg002-sample-ran-on-pag07506-flowcell)
  ...
  - [Assembly evaluation](#assembly-evaluation)
    - [hg38](#hg38-1)
    - [T2T](#t2t-1)
  - [SV-calling benchmarking](#sv-calling-benchmarking)
...
``` 
Memory issues: For some reasons, minimap or samtools right all the tmp files on disk and it will take as much as space is given. 
```
...
Concerning memory requirement, `lra` is more efficient than `minimap2`.
...
| Hg38                |         |          |              |                                       |                 |                 |                    |       |                                                                         |
|---------------------|---------|----------|--------------|---------------------------------------|-----------------|-----------------|--------------------|-------|-------------------------------------------------------------------------|
|                     | Contigs | N50      | Total length | Read to contig alignment mapping rate | Split read rate | Genome Coverage | Base pair accuracy | QV    | Structural error                                                        |
